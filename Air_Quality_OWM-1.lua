...
function QuickApp:getValues() -- Get the values
  ...
  data.AQI =  string.format("%.0f",jsonTable.list[1].main.aqi) -- Current values
  ...
  data.fcAQI =  string.format("%.0f",jsonTable.list[forecast+1].main.aqi) -- Forecast values
  data.fcCO =   string.format("%.2f",jsonTable.list[forecast+1].components.co)
  data.fcNO =   string.format("%.2f",jsonTable.list[forecast+1].components.no)
  data.fcNO2 =  string.format("%.2f",jsonTable.list[forecast+1].components.no2)
  data.fcO3 =   string.format("%.2f",jsonTable.list[forecast+1].components.o3)
  data.fcSO2 =  string.format("%.2f",jsonTable.list[forecast+1].components.so2)
  data.fcNH3 =  string.format("%.2f",jsonTable.list[forecast+1].components.nh3)
  data.fcPM25 = string.format("%.2f",jsonTable.list[forecast+1].components.pm2_5)
  data.fcPM10 = string.format("%.2f",jsonTable.list[forecast+1].components.pm10)
  data.fcDT =   os.date("%d-%m-%Y %H:%M", tonumber(jsonTable.list[forecast+1].dt))
